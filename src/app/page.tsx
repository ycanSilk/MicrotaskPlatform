      ...
      <div className="px-4 md:px-6 mb-12 md:mb-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 max-w-5xl mx-auto">
          ...
          <div className="bg-white rounded-2xl p-4 md:p-6 shadow-lg hover:shadow-xl transition-all border border-indigo-100">
            ...
            <a href="/api-page" className="block w-full py-3 px-4 bg-indigo-500 text-white rounded-lg text-center text-sm font-medium hover:bg-indigo-600 transition-colors">
              进入API测试平台 →
            </a>
          </div>
